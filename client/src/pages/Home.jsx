        ...
        return (
            <div>
                <div className = "title-main">
                    <div className = "title"><b>liv</b><br/></div>
                    <div className = "subtitle">Swedish for life, <em>liv</em> is a <b>wearable medical assistant</b> on your wrist that 
                        automates the process of seeking emergency care.</div>
                </div>
                
                <div className = "about">
                    <div className = "description-name"><b>How does liv work?</b><br/></div>
                    <div className = "description"><b>Liv is designed for anyone who is at risk of a medical emergency</b>, whether they are
                    ...
                    <div className = "description-name"><b>Major Features</b></div>
                        <div className = "description">While the wearable is on, Liv is able to <b>monitors heart rate vitals</b> in real time and send alerts when the heart rate is too high or too low.
                        Liv also includes <b>GPS tracking</b> and sends the location when the wearer has a medical emergency.</div>   

                    <div className = "description-name"><b>What happens in an emergency?</b></div>
                    <div className = "description">When an emergency occurs, the information of the wearer is sent to the nearest hospital which is then passed to the emergency responders. 
